...
public class Resistencia extends AppCompatActivity {
    ...
    Spinner banda1,banda2,banda3,multiplicador,tolerancia;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle(R.string.resistencias);
        ...
        ArrayAdapter<CharSequence> adapterbnd=ArrayAdapter.createFromResource(this,R.array.banda3,android.R.layout.simple_spinner_item);
        banda3.setAdapter(adapterbnd);
        multiplicador.setAdapter(adapter);
        ArrayAdapter<CharSequence> adptoler= ArrayAdapter.createFromResource(this,R.array.color2,android.R.layout.simple_spinner_item);
        tolerancia.setAdapter(adptoler);

        calcular.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String bd3=banda3.getSelectedItem().toString();
                ...
                if(bd3.equals("")){
                    ...
                    if(tol.equals("plateado")){pant.setText(pan+" Ω ±10%");}
                    if(tol.equals("cafe")){pant.setText(pan+" Ω ±1%");}
                    if(tol.equals("verde")){pant.setText(pan+" Ω ±0.5%");}
                    if(tol.equals("blue")){pant.setText(pan+" Ω ±0.25%");}
                    if(tol.equals("violeta")){pant.setText(pan+" Ω ±0.10%");}
                    if(tol.equals("gris")){pant.setText(pan+" Ω ±0.05%");}
                }
                else {
                    pant.setText(pan+=resistencia(bd1));
                    pant.setText(pan+=resistencia(bd2));
                    pant.setText(pan+=resistencia(bd3));
                    if(mlt.equals("negro")){ pan=(1*Double.parseDouble(pan))+""; pant.setText(pan);};
                    if(mlt.equals("cafe")){ pan=(10*Double.parseDouble(pan))+""; pant.setText(pan);};
                    if(mlt.equals("rojo")){ pan=(100*Double.parseDouble(pan))+""; pant.setText(pan);};
                    if(mlt.equals("naranja")){ pan=(1000*Double.parseDouble(pan))+""; pant.setText(pan);};
